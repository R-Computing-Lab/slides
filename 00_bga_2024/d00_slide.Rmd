...
# But that's... cliché. Let's see some other examples from Sewall Wright's work.
...
.pull-left-narrow[
- Wright's adaptive landscape diagram was an attemptt to reconcile Mendelian genetics and Darwinian evolution. (Shifting Balance Theory)
...
- (Ok technically Armand Janet's conceptualized this in 1895, but Wright's concept had a much larger impact.)
]
.footnote[]
]

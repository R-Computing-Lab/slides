...
savep
ggsave(savep,
       filename = "slides\\00_bga_2026\\img\\stacked_bar_log.png", width = 10, height = 6, dpi = 300)
```
```{r}
...
savep
ggsave(savep,filename = "slides\\00_bga_2026\\img\\stacked_bar_pattern.png", width = 10, height = 6, dpi = 300)
...
savep
ggsave(savep,
       filename = "slides\\00_bga_2026\\img\\stacked_bar_pattern_log.png", width = 10, height = 6, dpi = 300)
```
```{r}
p <- ggplot(df_long# %>% dplyr::filter(count < 1e13) 
  ) +
...
savep <- p + scale_y_continuous(labels = scales::label_comma(),breaks = waiver(),n.breaks = 6)+
  ...
  theme(legend.position = "bottom")+
   theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1))
savep
ggsave(savep,filename = "slides\\00_bga_2026\\img\\stacked_bar_pattern_all.png", width = 10, height = 6, dpi = 300)
...
savep <- p + scale_y_log10(labels = scales::label_log(),breaks = waiver(),n.breaks = 6)+
  ...
  theme(legend.position = "bottom")+
   theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1))
savep
ggsave(savep,filename = "slides\\00_bga_2026\\img\\stacked_bar_pattern_all_log.png", width = 10, height = 6, dpi = 300)
...
savep <- p + scale_y_log10(labels = scales::label_log(),breaks = waiver(),n.breaks = 6)+   scale_fill_manual(
  ...
  theme(legend.position = "bottom")+
   theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1))
savep
ggsave(savep,filename = "slides\\00_bga_2026\\img\\stacked_bar_pattern_all_log_filled.png", width = 10, height = 6, dpi = 300)
...
library(ggpedigree)
library(tidyverse)
df <- read_csv("slides\\00_bga_2026\\results.csv") %>% mutate(
...
savep
ggsave(savep,filename = "slides\\00_bga_2026\\img\\phis.png", width = 10, height = 6, dpi = 300)

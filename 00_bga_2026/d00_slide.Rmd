...
.footnote[.center[
[r-computing-lab.github.io/slides/00_bga_2026/d00_slide](https://r-computing-lab.github.io/slides/00_bga_2026/d00_slide.html)
]
]
...
- Longevity is heritable
  ...
  - Pedigree estimates: h² ≈ 25% + mt² ≈ 5% .small[(Burt, Garrison, et al 2025), ebiomedicine]
...
.small[Utah demographics from the Social Security Administration (1941 - 2023)]

```{r, echo=FALSE, out.height="88%", fig.align='right'}
#knitr::include_graphics("img/world_line_usa.png")
knitr::include_graphics("img/panel_UT_CI_continent_min_1900_croped.png")
```
]
.pull-right[
.small[Swedish demographics from Human Mortality Database (1750 - 2025)]
  
```{r, echo=FALSE, out.height="88%", fig.align='left'}
#knitr::include_graphics("img/world_line_usa.png")
...
.pull-right[
- More than **176,348,110** unique kinship pairs
  - 1st through 5th-degree and beyond
  - Multiple birth centuries represented
  - .small[(Same dataset as Burt, Garrison et al. (2025)]
...
knitr::include_graphics("img/patrilinefig.png")
```
...
.pull-right[
- Key test: If h² changes over time, distant kin should show it most clearly
- We expect to see a similar pattern that we found in Burt, Garrison et al. (2025)
...
# The Phenotype and Similarity Metric
...
- **Apply in the full UPDB**...
- **Extend to related aging outcomes**...
...
- **Funding**: National Institute on Aging [RF1-AG073189]
